...
function deleteMessage(msg, authorID) {
        ...
        if (permissions !== null) {
                ...
                if (permissions.has(Permissions.FLAGS.MANAGE_MESSAGES)) {
                        ...
                        embed = createEmbed();
                        msgAuthor.send({ embeds: [embed] }).catch(error => {})
...
function createEmbed() {
        const embed = new MessageEmbed()
                ...
                .setDescription('Profanity Filter just deleted a profane message you posted in a channel. If you believe this was a mistake, please contact a moderator or administrator')
